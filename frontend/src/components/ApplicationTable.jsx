  ...
  return (
    ...
    >
      <div className="rounded-2xl bg-white dark:bg-gray-900 p-6 overflow-x-auto max-w-full">
        ...
        <table className="min-w-[1200px] w-full border border-gray-200 rounded divide-y divide-gray-200 text-sm">
          <thead className="bg-gray-200">
            <tr>
              {[
                ...
                <th
                  key={header}
                  className="px-4 py-2 text-left text-sm font-semibold text-gray-700 whitespace-nowrap dark:text-gray-500 dark:bg-gray-800"
                >
                  {header}
                </th>
              ))}
          ...
          <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800">
            {(() => {
              // ✅ Map orgs for instant lookup by name
              const orgMap = Object.fromEntries(
                orgs.map((o) => [o.name?.toLowerCase().trim(), o])
              );

              return applications.map((app, index) => {
                const org = orgMap[app.companyName?.toLowerCase().trim()];
                ...
                return (
                  ...
                  >
                    <td className="px-3 py-2 align-top whitespace-nowrap dark:text-gray-300 dark:bg-gray-800">
                      {app.id}
                    </td>
                    ...
                    //   "consultancyName",
                      ...
                      <td
                        key={field}
                        className="px-3 py-2 align-top whitespace-nowrap dark:text-gray-300 dark:bg-gray-800"
                      >
                        {app.isEditing ? (
                          <input
                            type="text"
                    ...
                    {/* Action Buttons */}
                    <td className="px-3 py-2 align-top whitespace-nowrap space-x-2 dark:text-gray-300 dark:bg-gray-800">
                      {app.isEditing ? (
                        <>
                          <button
                    ...
                    <td className="px-3 py-2 align-top whitespace-nowrap dark:text-gray-300 dark:bg-gray-800">
                      <Link
                        ...
                        className="bg-teal-600 text-white px-3 py-1 rounded hover:bg-purple-700 text-sm"
                      >
                        View
                      </Link>
                    </td>
